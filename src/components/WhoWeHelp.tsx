...
const audiences = [
  {
    ...
    description: 'Turn your vision into a product: memberships, AI tools, apps, content engines, funnels, client journeys.',
  ...
  },
  {
    ...
    description: 'Offer your teachings digitally with clarity: course portals, booking flows, personalized AI guides, community spaces.',
  ...
  },
  {
    ...
    description: 'Get systems that save time and increase revenue: bookings, automations, customer flows, operations dashboards.',
  ...
  },
  {
    ...
    description: 'Need an MVP? Product direction? Execute fast with a fractional product + engineering partner.',
